...
public class Product_page 
{
   ...
   WebElement add_to_cart;
	...
	WebElement delete_the_product;
   
	@FindBy(xpath="//div[@class='sc-without-multicart']")
	WebElement No_of_item_display;
  ...
  public void review_rating(WebDriver driver)
   ...
   public void add_to_wishlist()
   {
	...
	{
		delete_the_product.click();
	}
	
	
	public void No_of_item_display(WebDriver driver)
	{
		String p=No_of_item_display.getText();
		System.out.println(p);
	String  oo=p.substring(15, 22);
