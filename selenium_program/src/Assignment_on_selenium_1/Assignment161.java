//Program to Launch the amazon, click the search the Category Dropdown and select the Amazon Devices using select by Visibletext
...
public class Assignment161 {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		WebElement j= god.findElement(By.id("twotabsearchtextbox"));
		 ...
		 h.selectByVisibleText("Amazon Devices");
